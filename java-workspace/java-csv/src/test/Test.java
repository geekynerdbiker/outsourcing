...
//        ****************************** test for Column ******************************
        ...
        columnIndex = (int) (Math.random() * table.getColumnCount());
        rowIndex = (int) (Math.random() * table.getColumn(columnIndex).count());
        columnName = table.getColumn(columnIndex).getHeader();
        table.selectRowsAt(rowIndex).print();
