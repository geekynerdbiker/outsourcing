...
class GetUnitTaken implements Function<Student, Student> {
    String unit;

    public GetUnitTaken(String unit) {
        this.unit = unit;
    }
...
public class StudentStats {
    ...
    public static Iterator<Student> unitNewestStudents(StudentList list, String unit) {
        ...
        return Itertools.take(Itertools.reversed(new StudentListIterator(list)),6);
    }
}
