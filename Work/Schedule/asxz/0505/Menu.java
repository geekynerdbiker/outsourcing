...
public class Menu
{
    ...
    public void runIt()
    {
        ...
        do
        {
            ...
            if (menuOpt.compareToIgnoreCase("T1") == 0 ) {optT1();}            
            if (menuOpt.compareToIgnoreCase("T2") == 0 ) {optT2();}
            if (menuOpt.compareToIgnoreCase("T3") == 0 ) {optT3();}
            if (menuOpt.compareToIgnoreCase("T4") == 0 ) {optT4();}
