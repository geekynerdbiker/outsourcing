...
placement_A <- read.csv("data/상품배치_A.csv", index_col="고객ID", encoding='euc-kr')
placement_B <- read.csv("data/상품배치_B.csv", engine="python", index_col="고객ID", encoding='euc-kr')
placement_C <- read.csv("data/상품배치_C.csv", engine="python", index_col="고객ID", encoding='euc-kr')
