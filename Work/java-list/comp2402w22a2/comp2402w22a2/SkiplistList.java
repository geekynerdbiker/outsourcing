...
public class SkiplistList<T> implements MyList<T> {
  ...
  public String toString() {
    ...
    public static void main(String[] args) {
        int n = 10; // Feel free to change this value and test more.
        ArrayList<Character> al = new ArrayList<>(n);
        for (int i = 0; i < n; i++) {
            al.add(i, (char) ('a' + (i % 60)));
        }
    ...
    public static void testInsertSingleBlock(int n) {
        ...
        // Create various "other" DLList to insert.
        SkiplistList<Integer> other0 = new SkiplistList<Integer>();
        SkiplistList<Integer> other1 = new SkiplistList<Integer>();
        SkiplistList<Integer> other2 = new SkiplistList<Integer>();

        for (int i = 0; i < 3; i++) { // makes "other"s with 3 elements, try other values
            other0.add(i, -1 - i);
            other1.add(i, -4 - i);
            other2.add(i, -7 - i);
        }
        ...
        ml.insertSingleBlock(ml.size(), other2);
        System.out.println(ml);


        System.out.println("remove all but first element");
        other0 = ml.removeFirst();
        System.out.println("ml.h: " + ml.h);
        System.out.println(ml);
        System.out.println("other0.h " + other0.h);
        System.out.println(other0);
        ml.insertSingleBlock(1, other0);
        System.out.println(ml);

        // Iterating by index can help you find problems with how you've set
        // the lengths. Using the iterator() won't find the length problems
        // because of how it iterates.
        for (int i = 0; i < ml.size(); i++) {
            System.out.println(ml.get(i));
        }
