...
public class sjf {
    ...
    static void SJF(int n, int AT[], int BT[], int WT[], int PN[]) {
        int i;
    ...
    static void sort1(int n, int PN[], int AT[], int BT[])
    {
    ...
    static void sort2(int n, int PN[], int AT[], int BT[])
    {
        int temp,min;
        int bttime = 0,k=1;
    ...
    public static void main(String[] args) throws IOException {
        File input_fp = new File("sjf.inp");
        File output_fp = new File("sjf.out");
