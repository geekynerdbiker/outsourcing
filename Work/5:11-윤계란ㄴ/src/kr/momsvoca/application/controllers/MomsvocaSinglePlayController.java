...
import kr.momsvoca.ImageUtility;
import kr.momsvoca.SpriteUtility;
import com.GoldenMine.Utility.Point;
//import com.momsvoca.application.*;
import kr.momsvoca.application.*;
...
public class MomsvocaSinglePlayController {
    MomsvocaModel model;
    MomsvocaView view;
    ...
    public MomsvocaSinglePlayController(MomsvocaModel model, MomsvocaView view) {
        this.model = model;
        this.view = view;
    }
