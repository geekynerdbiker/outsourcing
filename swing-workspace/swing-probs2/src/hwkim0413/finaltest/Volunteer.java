...
public class Volunteer {
    ...
    public String toString() {
        ...
        //구현해야 하는 부분 : 봉사활동 시간이 많은 순서로 정렬해서 문자열로 반환하기
            ...
            Collections.sort(this.member, new MemberComparator());

            for (Member m : this.member) {
                str += "회원 이름 : " + m.name + "\n";
                str += "성별 : " + m.gender + "\n";
                str += "나이 : " + m.age + "\n";
                str += "자원봉사 참여시간 : " + m.totalDonationTime + "시간\n";
            }
        }
    ...
    class MemberComparator implements Comparator<Member> {
        ...
        public int compare(Member o1, Member o2) {
            if (o1.totalDonationTime < o2.totalDonationTime) {
                return 1;
            } else if (o1.totalDonationTime > o2.totalDonationTime) {
                return -1;
            } else
                return 0;
        }
