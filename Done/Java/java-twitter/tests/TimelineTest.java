...
public class TimelineTest {
    ...
    @Test
    @Graded(description = "countTweets", marks = 2)
    ...
    @Test
    @Graded(description = "mostTweets", marks = 2)
    ...
    @Test
    @Graded(description = "mostActivity", marks = 2)
    ...
    @Test
    @Graded(description = "getAllTweetsByTimelineOwner", marks = 2)
    ...
    @Test
    @Graded(description = "printTimeline", marks = 2)
    ...
    @Test
    @Graded(description = "countSearchResults", marks = 2)
    ...
    @Test
    @Graded(description = "searchAll", marks = 2)
