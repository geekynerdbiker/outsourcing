...
//        Table innerJoined = testTable.innerJoin(rightTable, Arrays.asList(new JoinColumn("author_id", "id")));
//        innerJoined.show();
//
...
//        Table outerJoined = testTable.outerJoin(rightTable, Arrays.asList(new JoinColumn("translator_id", "id")));
//        outerJoined.show();
//
////        18) full outer join
////        Table fullOuterJoined = testTable.fullOuterJoin(rightTable, List.of(new JoinColumn("translator_id", "id")));
//        Table fullOuterJoined = testTable.fullOuterJoin(rightTable, Arrays.asList(new JoinColumn("translator_id", "id")));
