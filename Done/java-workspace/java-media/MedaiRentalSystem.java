...
public class MedaiRentalSystem {
    Manager manager;
    String directory;

    public MedaiRentalSystem() {
        manager = null;
    }
        ...
        if (scan.hasNextInt()) {
            ...
            try {
                ...
                if (Double.isNaN(price)) {
                    System.out.println("The media object id=" + id + " already rented.");
                } else {
    ...
    public static void main(String[] args) {
        ...
        MedaiRentalSystem handler = new MedaiRentalSystem();
        int answer;
