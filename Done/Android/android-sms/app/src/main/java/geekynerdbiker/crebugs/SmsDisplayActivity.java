...
public class SmsDisplayActivity extends AppCompatActivity { //객체 선언
    ...
    private void sendToServer(String sender, String receivedDate, String contents) {
        class sendData extends AsyncTask<Void, Void, String> {
            private static final String urls = "http://10.0.2.2:8080/result";
            ...
            protected String doInBackground(Void... voids) {
                try {
                    ...
                    request = new Request.Builder().url(urls).post(reqBody).build();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run()
                        {
                            if (result.equals("True"))
                                Toast.makeText(SmsDisplayActivity.this, "It's not Smishing.", Toast.LENGTH_SHORT).show();
                            else
                                Toast.makeText(SmsDisplayActivity.this, "It's Smishing!", Toast.LENGTH_SHORT).show();
                        }
                    }, 0);
