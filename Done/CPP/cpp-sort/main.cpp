...
//  cpp-sort
//
//  Created by Jacob An on 2022/03/01.
//
...
int main() {
    ...
    cout << "quick sort comparisons = " << quicksort<float>(arr2, n) << endl;
  
    string* arr3 = readFile<string>("a3test3.txt", n);
    cout << "merge sort comparisons = " << mergesort<string>(arr3, n) << endl;
