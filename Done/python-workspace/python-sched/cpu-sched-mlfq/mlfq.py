...
parser.add_option('-f', '--arrjobFront', help='add first arrived job to front of queue',
                  default=False, action='store_true', dest='arrjobFront')
...
arrjobFront = options.arrjobFront
...
print('OPTIONS arrjobFront', arrjobFront)
