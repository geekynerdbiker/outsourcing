...
CREATE TABLE myschema.building
(
...
(
    ...
    CONSTRAINT "BUILD_LECT_ID" FOREIGN KEY ("BUILDNO")
        REFERENCES myschema.building ("ABBR_NAME") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);

CREATE TABLE myschema.semester
(
...
CREATE TABLE myschema.timetable
(
    "NO" integer NOT NULL,
...
(
    ...
    CONSTRAINT "FAC_MAJOR_ID" FOREIGN KEY ("MAJOR_ID")
        REFERENCES myschema.college ("MAJOR_ID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
...
(
    ...
    CONSTRAINT "COURSE_FACULTY_ID" FOREIGN KEY ("PROF_ID")
        REFERENCES myschema.faculty ("ID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "COURSE_BUILD_ID" FOREIGN KEY ("BUILDNO", "ROOMNO")
        REFERENCES myschema.lectureroom ("BUILDNO", "ROOMNO") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);

CREATE TABLE myschema.course_registration
(
    "COURSE_ID" integer NOT NULL,
    "STUDENT_ID" character(10) NOT NULL,
    CONSTRAINT "COURSE_REGISTRATION_pkey" PRIMARY KEY ("STUDENT_ID", "COURSE_ID"),
    CONSTRAINT "CO_REG_1" FOREIGN KEY ("COURSE_ID")
        REFERENCES myschema.course ("COURSE_ID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "STU_REG_1" FOREIGN KEY ("STUDENT_ID")
        REFERENCES myschema.students ("STUDENT_ID") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);

CREATE TABLE myschema.course_to_time
(
    "COURSE_ID" integer NOT NULL,
    "DAY_OF_WEEK" character(3) NOT NULL,
    "NO" integer NOT NULL,
    ...
    CONSTRAINT "CTT2" FOREIGN KEY ("NO")
        REFERENCES myschema.timetable ("NO") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "CTT3" FOREIGN KEY ("DAY_OF_WEEK")
        REFERENCES myschema.day_of_week ("DAY_OF_WEEK") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);

CREATE TABLE myschema.grade
(
    "COURSE_ID" integer NOT NULL,
...
CREATE TABLE myschema.attendance
(
    "COURSE_ID" integer NOT NULL,
    "STUDENT_ID" character(10) NOT NULL,
