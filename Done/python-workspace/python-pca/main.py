...
tag = ['KL/HR', 'WT-PPM', 'degC', 'degC', 'Kg/cm2', 'Kg/cm2', 'L/HR', 'degC', 'Kg/cm2', '%',
       'Kg/cm2', 'KL/HR', 'degC', 'degC', 'Kg/cm2', 'degC', 'degC', 'degC', 'degC', 'degC', 'Kg/cm2', 'Kg/cm2', '%',
       'KL/HR',
       'MM' 'H2O', 'degC', 'KL/HR', 'degC', 'degC', 'KL/HR', 'degC', 'degC', 'degC', 'Kg/cm2', 'NM3/H', 'KL/HR', 'degC',
       'KL/HR', 'degC', 'degC', 'TON/H', 'KL/HR', 'degC', 'degC', 'Kg/cm2', 'Kg/cm2', 'NM3', 'KL/HR', 'degC', 'KL/HR',
       'degC', 'degC', 'degC', 'degC', 'KL/HR', 'degC', 'degC', 'degC', 'KL/HR', 'degC', 'MM' 'H2O', 'KL/HR', 'KL/HR',
       'degC',
       'MM' 'H2O', 'WT-PPM', 'degC', 'Kg/cm2', 'KL/HR', 'degC', 'degC', 'degC', 'degC', 'degC', 'KL/HR', 'degC', 'degC',
       'degC', 'KL/HR', 'MM', 'H2O', 'degC', 'KL/HR', 'degC', 'KL/HR', 'degC', 'degC', 'KL/HR', 'degC', 'KL/HR', 'degC',
       'Kg/cm2', 'TON/H', '%', 'degC', 'KL/HR']

# mean = np.mean(train, axis=0)
# std = np.std(train, axis=0)
#
# for i in range(len(std)):
#     if std[i] == 0 or std[i] > 10:
#         std[i] = 1
# print(std)
#
