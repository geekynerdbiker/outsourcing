...
const submit = () => {
    ...
    if (data[data.length - 1].balance >= displayedNumber && displayedNumber > 0 && !(from === "Choose an Account" || to === "Choose an Account")) { // save and redirect
    ...
    } else if (data[data.length - 1].balance < displayedNumber) {
        alert("Not enough amount to transfer");
    } else {
