...
if __name__ == '__main__':
    ...
    if options.runTest != None:
        ...
        result = evaluate(options.generateSolutions, options.testRoot, moduleDict,
        ...
        print(result)
        total_score = 0
        max_scores = {'q1': 2, 'q2': 3, 'q3': 2, 'q4': 2, 'q5': 1, 'q6': 3,'q7': 3, 'q8': 1,'q9': 2,'q10': 3, 'q11': 3} 
        for x in result:
            passed = "failed"
            if result[x] == max_scores[x]:
                passed = "passed"
            scores[x] = { 'name': x, 'score': result[x], 'max_score': max_scores[x], "status": passed}
            total_score += result[x]
        
        json_file = {"tests": [scores[x] for x in result]}
